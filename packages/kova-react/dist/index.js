...
import { adminClient, twoFactorClient, organizationClient, multiSessionClient, magicLinkClient, usernameClient, genericOAuthClient } from 'better-auth/client/plugins';
...
var KovaAuthContext = createContext(null);
...
function KovaAuthProvider({
  ...
  const setPersistentSessionToken = useCallback((token) => {
  ...
  const [serverAppearance, setServerAppearance] = useState(null);
  useEffect(() => {
  ...
  return /* @__PURE__ */ jsx(KovaAuthContext.Provider, { value, children });
}
...
function DiscordIcon({ size = 18, style }) {
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      style,
      children: [
        /* @__PURE__ */ jsx("rect", { width: "24", height: "24", rx: "6", fill: "#5865F2" }),
        /* @__PURE__ */ jsx(
          "path",
          {
            fill: "white",
...
function MicrosoftIcon({ size = 18, style }) {
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      style,
      children: [
        /* @__PURE__ */ jsx("path", { d: "M11.4 11.4H2V2h9.4v9.4z", fill: "#F35325" }),
        /* @__PURE__ */ jsx("path", { d: "M22 11.4h-9.4V2H22v9.4z", fill: "#81BC06" }),
        /* @__PURE__ */ jsx("path", { d: "M11.4 22H2v-9.4h9.4V22z", fill: "#05A6F0" }),
        /* @__PURE__ */ jsx("path", { d: "M22 22h-9.4v-9.4H22V22z", fill: "#FFBA08" })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("path", { d: "M21 2l-9.6 9.6" }),
        /* @__PURE__ */ jsx("path", { d: "M15.5 7.5l3 3L22 7l-3-3" })
      ]
    }
  );
}
...
function FingerprintIcon({ size = 18, style }) {
  return /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      style,
      children: [
        /* @__PURE__ */ jsx("path", { d: "M2 13.5V11a10 10 0 0 1 20 0v2.5" }),
        /* @__PURE__ */ jsx("path", { d: "M6 12a6 6 0 0 1 12 0" }),
        /* @__PURE__ */ jsx("path", { d: "M10 12a2 2 0 0 1 4 0c0 3-2 4-2 4" }),
        /* @__PURE__ */ jsx("path", { d: "M10 19h.01" })
      ]
    }
  );
}
...
function ProviderIcon({ provider, size, style }) {
  switch (provider.toLowerCase()) {
    case "google":
      return /* @__PURE__ */ jsx(GoogleIcon, { size, style });
    case "discord":
      return /* @__PURE__ */ jsx(DiscordIcon, { size, style });
    case "github":
      return /* @__PURE__ */ jsx(GitHubIcon, { size, style });
    case "microsoft":
      return /* @__PURE__ */ jsx(MicrosoftIcon, { size, style });
    case "apple":
      return /* @__PURE__ */ jsx(AppleIcon, { size, style });
    case "facebook":
      return /* @__PURE__ */ jsx(FacebookIcon, { size, style });
    case "twitter":
    case "x":
      return /* @__PURE__ */ jsx(TwitterIcon, { size, style });
    default:
      return /* @__PURE__ */ jsx(KeyIcon, { size, style });
  }
}
...
function Divider({
  ...
  return /* @__PURE__ */ jsxs("div", { "data-ra-element": "dividerRow", style: elements?.dividerRow, children: [
    /* @__PURE__ */ jsx("div", { "data-ra-element": "dividerLine", style: elements?.dividerLine }),
    /* @__PURE__ */ jsx("span", { "data-ra-element": "dividerText", style: elements?.dividerText, children: label }),
    /* @__PURE__ */ jsx("div", { "data-ra-element": "dividerLine", style: elements?.dividerLine })
  ] });
}
function FormField({
  ...
  return /* @__PURE__ */ jsxs("div", { "data-ra-element": "formField", style: elements?.formField, children: [
    /* @__PURE__ */ jsx(
      "label",
      {
        htmlFor: id,
  ...
  return /* @__PURE__ */ jsx(
    "button",
    {
      ...
      children: isLoading ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(Spinner, { size: 13, style: { borderTopColor: "#fff" } }),
        "Loading\u2026"
      ] }) : children
    }
  );
...
function Avatar({
  ...
  if (src && !imgError) {
    return /* @__PURE__ */ jsx("span", { style: base, children: /* @__PURE__ */ jsx(
      "img",
      {
        src,
        alt: name ?? "Avatar",
...
function KovaAuthBranding() {
  ...
  return /* @__PURE__ */ jsxs(
    "a",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", "aria-hidden": "true", children: [
          /* @__PURE__ */ jsx("circle", { cx: "12", cy: "12", r: "10", fill: "var(--ra-color-primary)", opacity: "0.9" }),
          /* @__PURE__ */ jsx("path", { d: "M8 16V8h5a3 3 0 0 1 0 6H8", stroke: "#fff", strokeWidth: "2", strokeLinecap: "round" })
        ] }),
...
function CardHeader({
  ...
  return /* @__PURE__ */ jsxs("div", { "data-ra-element": "cardHeader", style: elements?.cardHeader, children: [
    ...
    /* @__PURE__ */ jsx("h1", { "data-ra-element": "cardTitle", style: elements?.cardTitle, children: title }),
    subtitle && /* @__PURE__ */ jsx("p", { "data-ra-element": "cardSubtitle", style: elements?.cardSubtitle, children: subtitle })
  ] });
}
function CardBody({
  children,
  ...
  return /* @__PURE__ */ jsx("div", { "data-ra-element": "cardBody", style: elements?.cardBody, children });
}
function CardFooter({
  children,
  elements
}) {
  return /* @__PURE__ */ jsxs("div", { "data-ra-element": "cardFooter", style: elements?.cardFooter, children: [
    children,
    /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center" }, children: [
      /* @__PURE__ */ jsx(KovaAuthBranding, {}),
      /* @__PURE__ */ jsx(DevModeBadge, {})
    ] })
  ] });
}
function Tabs({
...
function ProviderDisplayIcon({ provider }) {
  if (provider === "credential") {
    return /* @__PURE__ */ jsx(KeyIcon, { size: 15, style: { color: "var(--ra-color-text-secondary)" } });
  }
  return /* @__PURE__ */ jsx(ProviderIcon, { provider, size: 15 });
}
function ConnectedAccounts({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        error && /* @__PURE__ */ jsx(Alert, { variant: "error", style: { marginBottom: 8, fontSize: "0.75rem" }, children: error }),
        /* @__PURE__ */ jsx("div", { style: gridStyle, children: visibleProviders.map((providerId) => {
          ...
          return /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx(ProviderDisplayIcon, { provider: providerId }),
                /* @__PURE__ */ jsx(
                  "span",
                  {
                ...
                isConnected ? /* @__PURE__ */ jsxs(
                  "span",
                  {
                    ...
                    title: "Connected",
                    children: [
                      /* @__PURE__ */ jsx(CheckIcon, { size: 11 }),
                      "Connected"
                    ]
                  }
                  ...
                  "button",
                  {
                    ...
                    children: [
                      isLinking ? /* @__PURE__ */ jsx(Spinner, { size: 10 }) : null,
      ...
      children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            onClick: () => setOpen((v) => !v),
            children: [
              activeOrg ? /* @__PURE__ */ jsx(OrgAvatar, { name: activeOrg.name, logo: activeOrg.logo }) : /* @__PURE__ */ jsx(
                "span",
                {
                  style: {
                    width: 24,
                  ...
                  children: /* @__PURE__ */ jsx(BuildingIcon, { size: 12, style: { color: "var(--ra-color-text-tertiary)" } })
                }
              ),
            ...
            children: [
              ...
              /* @__PURE__ */ jsx(
                OrgOption,
                {
                  ...
                  icon: /* @__PURE__ */ jsx(UserIcon, { size: 13, style: { color: "var(--ra-color-text-tertiary)" } }),
                  onSelect: () => void handleSetActive(null),
                  el
                }
              ),
              orgs === null ? /* @__PURE__ */ jsxs(
                "div",
                {
                  style: {
                    padding: "10px 8px",
                ...
                OrgOption,
                {
                  ...
                  icon: /* @__PURE__ */ jsx(OrgAvatar, { name: org.name, logo: org.logo, size: 22 }),
...
function OrgOption({
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        isSwitching ? /* @__PURE__ */ jsx(Spinner, { size: 14 }) : icon,
        /* @__PURE__ */ jsxs("div", { style: { flex: 1, minWidth: 0, textAlign: "left" }, children: [
          /* @__PURE__ */ jsx(
            "p",
            {
        ...
        isActive && /* @__PURE__ */ jsx(CheckIcon, { size: 11, style: { color: "var(--ra-color-primary)", flexShrink: 0 } })
      ]
    }
  );
}
...
function Protect({
  ...
  if (!conditionMet) return /* @__PURE__ */ jsx(Fragment, { children: fallback });
...
function useRateLimit() {
  ...
  const recordRateLimit = useCallback((retryAfterSeconds) => {
...
function SocialButtons({
  ...
  return /* @__PURE__ */ jsxs("div", { "data-ra-element": "socialButtonsRoot", style: elements?.socialButtonsRoot, children: [
    oauthError && /* @__PURE__ */ jsx(Alert, { variant: "error", children: oauthError }),
    oauthProviders.map((p) => /* @__PURE__ */ jsxs(
      "button",
      {
        type: "button",
        "data-ra-element": "socialButton",
        ...
        children: [
          /* @__PURE__ */ jsx(ProviderIcon, { provider: p.id, size: 18 }),
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsx(FingerprintIcon, { size: 18 }),
...
function EmailPasswordForm({
  ...
  const [prevRetryAfter, setPrevRetryAfter] = useState(null);
  ...
  if (twoFactorRequired) {
    return /* @__PURE__ */ jsxs("form", { onSubmit: (e) => void handleSubmit(e), noValidate: true, children: [
      /* @__PURE__ */ jsx(Alert, { variant: "info", children: "Two-factor authentication required. Enter your 6-digit code." }),
      error && /* @__PURE__ */ jsx(Alert, { variant: "error", children: error }),
      isRateLimited && /* @__PURE__ */ jsx(
        RateLimitBanner,
        {
          secondsRemaining,
      ...
      /* @__PURE__ */ jsx(SubmitButton, { isLoading, disabled: isRateLimited, elements, children: "Verify Code" })
    ] });
  }
  return /* @__PURE__ */ jsxs("form", { onSubmit: (e) => void handleSubmit(e), noValidate: true, children: [
    error && !isRateLimited && /* @__PURE__ */ jsx(Alert, { variant: "error", children: error }),
    isRateLimited && /* @__PURE__ */ jsx(
      RateLimitBanner,
      {
        secondsRemaining,
    ...
    /* @__PURE__ */ jsx(SubmitButton, { isLoading, disabled: isRateLimited, elements, children: "Continue" })
  ] });
}
function MagicLinkForm({
  ...
  if (sent) {
    return /* @__PURE__ */ jsx(Alert, { variant: "success", children: "\u2709\uFE0F Magic link sent! Check your email and click the link to sign in." });
  }
  return /* @__PURE__ */ jsxs("form", { onSubmit: (e) => void handleSubmit(e), noValidate: true, children: [
    error && !isRateLimited && /* @__PURE__ */ jsx(Alert, { variant: "error", children: error }),
    isRateLimited && /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsxs(SubmitButton, { isLoading, disabled: isRateLimited, elements, children: [
      /* @__PURE__ */ jsx(MailIcon, { size: 15 }),
      "Send sign-in link"
    ] })
  ] });
}
...
function SignIn({
  ...
  if (!isAppearanceLoaded) {
    return /* @__PURE__ */ jsxs(Card, { elements: el, className, children: [
      /* @__PURE__ */ jsx(CardHeader, { title: "Sign in", subtitle: "Welcome back. Choose your sign-in method.", elements: el }),
      /* @__PURE__ */ jsxs(CardBody, { elements: el, children: [
        /* @__PURE__ */ jsxs("div", { "data-ra-element": "socialButtonsRoot", style: el.socialButtonsRoot, children: [
          /* @__PURE__ */ jsx(Skeleton, { height: 38 }),
          /* @__PURE__ */ jsx(Skeleton, { height: 38 }),
          /* @__PURE__ */ jsx(Skeleton, { height: 38 })
        ] }),
        /* @__PURE__ */ jsx(Divider, { elements: el }),
        /* @__PURE__ */ jsx(Skeleton, { height: 42, style: { marginBottom: 20 } }),
        /* @__PURE__ */ jsx(Skeleton, { height: 36, style: { marginBottom: 14 } }),
        /* @__PURE__ */ jsx(Skeleton, { height: 36, style: { marginBottom: 14 } }),
  ...
  return /* @__PURE__ */ jsxs(Card, { elements: el, className, children: [
    ...
    /* @__PURE__ */ jsxs(CardBody, { elements: el, children: [
      oauthProviders.length > 0 && /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(
          SocialButtons,
          {
            elements: el,
      ...
      activeTab === "email" && /* @__PURE__ */ jsx(EmailPasswordForm, { afterSignInUrl: resolvedUrl, elements: el }),
      activeTab === "magic-link" && /* @__PURE__ */ jsx(MagicLinkForm, { afterSignInUrl: resolvedUrl, elements: el }),
      activeTab === "passkey" && /* @__PURE__ */ jsx(PasskeyButton, { elements: el, callbackURL: resolvedUrl })
    ] }),
    /* @__PURE__ */ jsxs(CardFooter, { elements: el, children: [
      /* @__PURE__ */ jsxs("span", { style: { color: "var(--ra-color-text-tertiary)" }, children: [
        "Don't have an account?",
        " "
      ] }),
      /* @__PURE__ */ jsx("a", { href: signUpUrl, children: "Sign up" })
    ] })
  ] });
}
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: PASSWORD_RULES.map((r) => /* @__PURE__ */ jsxs(
              "span",
              {
                style: {
                  fontFamily: "var(--ra-font-mono)",
...
function SignUp({
  ...
  if (verificationPending) {
    return /* @__PURE__ */ jsxs(Card, { elements: el, className, children: [
      ...
      /* @__PURE__ */ jsx(CardBody, { elements: el, children: /* @__PURE__ */ jsxs(Alert, { variant: "info", children: [
      ...
      /* @__PURE__ */ jsx(CardFooter, { elements: el, children: /* @__PURE__ */ jsx("a", { href: signInUrl, children: "Back to sign in" }) })
    ] });
  }
  return /* @__PURE__ */ jsxs(Card, { elements: el, className, children: [
    /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsxs(CardBody, { elements: el, children: [
      oauthProviders.length > 0 && /* @__PURE__ */ jsx(
        SocialButtons,
        {
          callbackURL: resolvedUrl,
      ...
      oauthProviders.length > 0 && /* @__PURE__ */ jsx(Divider, { elements: el }),
      /* @__PURE__ */ jsxs("form", { onSubmit: (e) => void handleSubmit(e), noValidate: true, children: [
        error && !isRateLimited && /* @__PURE__ */ jsx(Alert, { variant: "error", children: error }),
        isRateLimited && /* @__PURE__ */ jsx(
          RateLimitBanner,
          {
        ...
        /* @__PURE__ */ jsx(SubmitButton, { isLoading, disabled: isRateLimited, elements: el, children: "Create account" })
      ] })
    ] }),
    /* @__PURE__ */ jsxs(CardFooter, { elements: el, children: [
      /* @__PURE__ */ jsxs("span", { style: { color: "var(--ra-color-text-tertiary)" }, children: [
      ...
      /* @__PURE__ */ jsx("a", { href: signInUrl, children: "Sign in" })
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    others.map((s) => /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          switching === s.session.token ? /* @__PURE__ */ jsx(Spinner, { size: 14 }) : /* @__PURE__ */ jsx(
            Avatar,
            {
              src: s.user.image,
      ...
      children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            className,
            children: [
              signingOut ? /* @__PURE__ */ jsx(Spinner, { size }) : /* @__PURE__ */ jsx(Avatar, { src: user.image, name: user.name, size }),
            ...
            children: [
              /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx(Avatar, { src: user.image, name: user.name, size: 36 }),
              ...
              /* @__PURE__ */ jsxs("div", { style: { padding: "4px 0" }, children: [
                ...
                /* @__PURE__ */ jsxs(
                  "button",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx("span", { style: { flex: 1 }, children: "Connected accounts" }),
                      /* @__PURE__ */ jsx(
                        ChevronDownIcon,
                        {
                          size: 10,
                ...
                showLinkedAccounts && /* @__PURE__ */ jsx(
                  "div",
                  {
                    style: {
                      padding: "0 12px 4px",
...
export { ConnectedAccounts, KovaAuthProvider, OrgSwitcher, Protect, SignIn, SignUp, UserButton, createKovaAuthClient, decodePublishableKey, encodePublishableKey, extractRetryAfter, rateLimitMessage, useAuth, useKovaAuth, useLinkedAccounts, useOrganization, useRateLimit, useSession, useSignIn, useSignUp, useUser, verifyWebhookSignature };
