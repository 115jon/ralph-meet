        ...
        {status === 'preview' && invite && (
          <div className="flex flex-col items-center gap-6 rounded-2xl bg-rm-bg-secondary/80 p-8 shadow-2xl ring-1 ring-white/[0.06] backdrop-blur-xl">
            ...
            <div className="flex w-full items-center gap-4 rounded-xl bg-rm-bg-primary/60 p-4 ring-1 ring-white/[0.06]">
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-rm-accent-dim ring-1 ring-white/10 overflow-hidden">
            ...
            <button
              onClick={joinServer}
              className="w-full rounded-xl bg-rm-accent px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-rm-accent/20 transition-all duration-200 hover:bg-rm-accent-hover hover:shadow-rm-accent/30 active:scale-[0.98] cursor-pointer"
            >
              Accept Invite
            </button>
