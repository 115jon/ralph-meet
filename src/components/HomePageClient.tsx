...
function HomePageCTA({ joinRoom, room, setRoom }: { joinRoom: (e: React.FormEvent) => void, room: string, setRoom: (r: string) => void }) {
  return (
...
export default function HomePageClient() {
  ...
  return (
    <div className="relative flex min-h-full flex-col overflow-y-auto bg-[#0a0a0a] selection:bg-indigo-500/30">
      ...
      <HomePageHeader profileOpen={profileOpen} setProfileOpen={setProfileOpen} />
