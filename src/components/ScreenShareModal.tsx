...
export const ScreenShareModal: React.FC<ScreenShareModalProps> = ({
  ...
  const setScreenShareDefaults = useVoiceSettingsStore(
    (s) => s.setScreenShareDefaults,
  );
  const initialQuality = availableQualities.includes(
  ...
  const qualities = [
    {
      ...
      label: "720p",
      fps: "30 FPS",
      desc: "Standard HD. Reliable and efficient.",
    },
    {
      id: "720p60",
      label: "720p",
      fps: "60 FPS",
      desc: "Smooth HD. Better for gaming/video.",
    },
    {
      id: "1080p30",
      label: "1080p",
      fps: "30 FPS",
      desc: "Full HD. High detail for text/apps.",
    },
    {
      id: "1080p60",
      label: "1080p",
      fps: "60 FPS",
      desc: "Pro Grade. Maximum smoothness and detail.",
    },
    {
      id: "1440p30",
      label: "1440p",
      fps: "30 FPS",
      desc: "2K Quality. Ultra sharp.",
    },
    {
      id: "1440p60",
      label: "1440p",
      fps: "60 FPS",
      desc: "2K High Motion. The sweet spot for gamers.",
    },
    {
      id: "4k30",
      label: "4k",
      fps: "30 FPS",
      desc: "Ultra HD. Cinema grade detail.",
    },
    {
      id: "4k60",
      label: "4k",
      fps: "60 FPS",
      desc: "The Ultimate. Highest possible fidelity.",
    },
  ...
  return (
    <BaseModal onClose={onClose}>
      <div
        className={cn(
          "fixed inset-0 z-[200] flex items-center justify-center bg-black/80 backdrop-blur-sm duration-200",
      ...
      >
        <dialog
          open
          className={cn(
            "relative m-0 flex w-[calc(100%-2rem)] max-w-xl flex-col overflow-hidden rounded-2xl border border-rm-border bg-rm-bg-primary p-0 shadow-2xl outline-none duration-300",
            isClosing
        ...
        >
          ...
          <div className="p-6 pb-2">
            ...
            <p className="text-sm text-rm-text-muted">
              Choose your stream quality and settings. Higher settings require
              more bandwidth and CPU.
            </p>
          </div>
          ...
          <div className="space-y-6 p-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              {qualities.map((q) => (
                ...
                >
                  ...
                  <p className="line-clamp-1 text-[10px] leading-tight text-rm-text-muted group-hover:text-rm-text-secondary">
                    {q.desc}
                  </p>
                  ...
                  {q.id.includes("60") && (
                    <div className="absolute -right-1 -top-1 p-1">
                      <Zap
                        size={10}
                        className="fill-warning text-warning opacity-50"
                      />
                    </div>
                  )}
                </button>
            ...
            <div className="space-y-3">
              <h3 className="px-1 text-[10px] font-black uppercase tracking-widest text-rm-text-muted/40">
                Settings
              </h3>
              <button
                type="button"
                  ...
                  <div
                    className={cn(
                      ...
                      withAudio
                        ...
                        : "bg-rm-bg-elevated/40 text-rm-text-muted/20",
                    )}
                  >
                    <Music size={18} />
                  </div>
                  <div>
                    <div className="text-xs font-bold text-rm-text">
                      Share Audio
                    </div>
                    <div className="text-[10px] text-rm-text-muted">
                      Monitor shares include system audio. App shares include
                      only that app's audio when supported.
                    </div>
                  </div>
                </div>
                <div
              ...
              <div className="flex gap-3 rounded-xl border border-warning/10 bg-warning/5 p-3">
                ...
                <p className="text-[10px] leading-relaxed italic text-warning/60">
                  Pro Tip: Use{" "}
                  <span className="font-bold text-warning">1080p / 30 FPS</span>{" "}
                  for productivity and coding. Switch to{" "}
                  <span className="font-bold text-warning">60 FPS</span> for
                  smooth gameplay and video playback.
                </p>
              </div>
            </div>
          </div>
