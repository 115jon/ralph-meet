  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[var(--rm-bg-primary)] px-6 selection:bg-indigo-500/30">
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center overflow-hidden">
        <div className="absolute left-[-10%] top-[-10%] h-[600px] w-[600px] animate-pulse rounded-full bg-indigo-500/10 mix-blend-screen blur-[120px]" style={{ animationDuration: "8s" }} />
      ...
      <main className="relative z-10 flex w-full max-w-[420px] flex-col items-center gap-8">
        <Link to="/" className="group flex flex-col items-center gap-4 rounded-3xl no-underline outline-none hover:no-underline focus-visible:ring-2 focus-visible:ring-indigo-500/50 focus-visible:ring-offset-2 focus-visible:ring-offset-black">
          <div className="relative flex h-20 w-20 animate-[float_4s_ease-in-out_infinite] items-center justify-center rounded-[1.5rem] bg-gradient-to-br from-indigo-500/10 to-purple-500/10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_0_40px_-10px_rgba(99,102,241,0.2)] ring-1 ring-white/10 transition-transform duration-500 group-hover:scale-105 group-hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_0_60px_-15px_rgba(99,102,241,0.4)]">
