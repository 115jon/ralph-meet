// ============================================================================
// RtcRoomMedia - RTC_ROOM-owned WebRTC media signaling implementation
//
...
const log = clog("RtcRoomMediaGW");
const roomLog = clog("RtcRoomMedia");
const sfuLog = clog("RtcRoomMedia:SFU");
...
// ── RTC_ROOM media implementation ───────────────────────────────────────────

export class RtcRoomMedia {
  ...
  private async sfuFetch(
    ...
    for (let attempt = 0; attempt < 2; attempt++) {
      ...
      try {
        ...
        sfuLog.error(`${method} ${path} failed (${resp.status}):`, text);
