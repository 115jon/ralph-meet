...
pub struct ReceivedNotification {
    ...
    pub(crate) notification: Option<DeliveredNotification>,
}
...
impl From<&NotificationData> for DeliveredNotification {
    fn from(value: &NotificationData) -> Self {
        Self {
            ...
            action_type_id: value.action_type_id.clone(),
            extra: value.extra.clone(),
            attachments: value.attachments.clone(),
            icon: value.icon.clone(),
            large_icon: value.large_icon.clone(),
        }
    }
}
...
pub struct ActionType {
    ...
    pub(crate) hidden_previews_body_placeholder: Option<String>,
    #[serde(default)]
    pub(crate) custom_dismiss_action: bool,
    #[serde(default)]
    pub(crate) allow_in_car_play: bool,
    #[serde(default)]
    pub(crate) hidden_previews_show_title: bool,
    #[serde(default)]
    pub(crate) hidden_previews_show_subtitle: bool,
}
...
pub struct Action {
    ...
    pub(crate) input_button_title: Option<String>,
